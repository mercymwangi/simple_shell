 ...
 *
 * Descrbe: main
 * the extended functions main file
 */
...
int parse_command(char *command)
{
	...
	/* @check_path - check for command at the PATH */
...
/**
 * execute_command - execut a command type
 * @tokenized_command: tokenized form of the command (ls -l == {ls
...
/**
 * get_func - retrieves a function based on the commands
